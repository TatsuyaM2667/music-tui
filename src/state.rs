...
pub struct AppState {
    ...
    // 動画フレーム: Raw RGB + サイズ + 描画済みセルバッファ
    pub video_rgb: Option<(Vec<u8>, u32, u32)>,
    pub video_cells: Option<Vec<u8>>,
    pub video_cell_area: Option<Rect>,
    pub video_frame_dirty: bool,
